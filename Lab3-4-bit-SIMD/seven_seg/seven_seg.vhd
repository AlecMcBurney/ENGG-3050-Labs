...
entity sevseg_disp is
    Port (
        I_0, I_1, I_2, I_3, I_4, I_5, I_6, I_7 : in std_logic_vector(4 downto 0); -- 0=Dot
        -- DOT : in std_logic;
...
architecture Behavioral of sevseg_disp is
	...
	Port (  
            int  : in std_logic_vector (3 downto 0);--same input vector here
			dot : in std_logic;
            seg : out std_logic_vector (7 downto 0) -- 6-0 bits are cathodes, 7 bit is dot. -- 0 is dot on, 1 is dot off
        );
	end component;
	
    signal VAL : std_logic_vector(4 downto 0); -- output of cathode MUX to input of 7 SEG encoder
begin
